...
hs_fil = hs.readlines()
hs.close()
A0, atoms0, coords0, coords_type0, masses0, kpoints0 = load_atomic_pos(
    hs_fil, return_kpoints=True
)
...
for x in range(0, 20):
    ...
    cell_writer(
        hs_fil, coords_new, A_new, atoms0, coords_type0, kpoints0, fil + "." + str(xx)
    )
